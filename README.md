...
Semantic html allows you to build a webpage so that the tags have meaning and allows other coders and screen readers to more easily navigate your page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block allows you to style a block on a page. Display inline is put into a already existing block.
...
git allows you to multiple versions of a project and lets you roll back to a previous version if necessary. It also allows multiple developers to work on the same project.
